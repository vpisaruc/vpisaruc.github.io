...
window.onload = function() {
  ...
  en : {
    ...
    w_pl0: `<span>07.2021 - Present</span> <strong>OZON</strong> <br> <strong>Department:</strong> OZON Classified <br> <strong>Position:</strong> Team Lead Product Analyst`,
    ...
    w_pl1: "<span>11.2020 - 07.2021</span> <strong>«DOM.RF Bank»</strong> <br> <strong>Department:</strong> Mortgage business <br> <strong>Position:</strong> Team Lead Product Analyst",
  ...
  ru : {
    fio:"Писарук Виктор",
    bio:"Team Lead Product Analyst<br>26 лет<br>Москва<br>Гражданство: Молдова",
    w_exp: "Опыт работы",
    w_pl0: `<span>07.2021 - Н.В.</span> <strong>OZON</strong> <br> <strong>Отдел:</strong> OZON Объявления <br> <strong>Позиция:</strong> Team Lead Product Analyst`,
    jd_0: `<p><strong>Обязанности:</strong></p>
            <ul class="job-description">
              ...
              <li>Создание разметки аналитики всего продукта</li>
              <li>Постановка и запуск A/B тестов</li>
              <li>Обучение продуктовой команды Data Driven подходу</li>
            </ul>`,
    w_pl1:"<span>11.2020 - 07.2021</span> <strong>АО «Банк ДОМ.РФ»</strong> <br> <strong>Отдел:</strong> Проекты ипотечного бизнеса <br> <strong>Позиция:</strong> Team Lead Product Analyst",
  ...
  skills: `<h3>Профессиональные навыки</h3>
          <div>
            <div class='column'>
              <ul class="job-description">
                <li>Управление командой и Обучение сотрудников</li>
                <li>Построение систем продуктовых KPI</li>
                <li>Оценка юнит-экономики и поиск точек роста продукта</li>
                <li>Построение архитектуры аналитики продукта с нуля</li>
                <li>Запуск и оценка А/Б тестов</li>
                <li>Уверенное знание SQL</li>
                <li>Создание ETL процессов: Airflow</li>
                <li>Создание аналитических пакетов</li>
                <li>Языки программирования на уверенном уровне: Python, C/C++</li>
                ...
                <li>Продвинутый пользователь инструментов визуализации: Tableau, Superset, SAP </li>
